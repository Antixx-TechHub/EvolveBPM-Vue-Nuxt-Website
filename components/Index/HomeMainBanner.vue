          ...
          <div class="row">
            <div class="col-lg-6 d-flex align-items-center">
              <div class="header-heading">
                ...
                <a href="#" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">Get Strategy Call <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
              </div>
            </div>
            <!-- <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
              <div class="single-image"><img src="images/hero/leads-hero.png" alt="hero image" class="img-fluid" /></div>
            </div> -->
          </div>
        </div>
      </div>
